...
- (void)applicationDidBecomeActive:(UIApplication *)application {
	...
	// make sure we process any shares that happened while we were away
	[[NSNotificationCenter defaultCenter] postNotificationName:@"checkShares" object:nil userInfo:nil];
}
